		...
		<!--Check boxes to choose statuses-->
                <div class="category">          
                        ...
                        <legend>I am a (please check all that apply):</legend>
                                <input type="checkbox" value="veteran" name="veteran" <?php echo ($_SESSION['veteran'] === "veteran")?"checked":""; ?>>
                                                        <label>Veteran</label><br>
                                <input type="checkbox" value="international" name="is" <?php echo ($_SESSION['is'] === "international")?"checked":""; ?>>
                                                        <label>International student</label><br>
                                <input type="checkbox" value="running-start" name="rs" <?php echo ($_SESSION['rs'] === "running-start")?"checked":""; ?>>
